<aside class="panel-sidebar" aria-label="Navegación administrativa">
    <a class="panel-marca" href="panel_administrador.php" aria-label="Volver al panel administrativo">
    ...
    <nav class="panel-nav">
        ...
        <a class="panel-nav-item panel-nav-activo" href="panel_administrador.php"><svg class="nav-icon icon" viewBox="0 0 24 24" aria-hidden="true"><path d="m3 10 9-7 9 7v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><path d="M9 22V12h6v10"/></svg><span>Panel</span></a>
        <div class="panel-nav-label">Usuarios</div>
        <a class="panel-nav-item" href="listado.php?tipo=administradores"><svg class="nav-icon icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/></svg><span>Administradores</span></a>
        <a class="panel-nav-item" href="listado.php?tipo=maestros"><svg class="nav-icon icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M2 10 12 5l10 5-10 5L2 10Z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/><path d="M22 10v6"/></svg><span>Maestros</span></a>
